...
export const LEARNING_ROADMAP_STAGES: LearningRoadmapStage[] = [
  {
    id: 'stage-0-zero-to-basics',
    stepNumber: 1,
    stageName: 'From Zero: Studio & Luau Basics',
    thaiStageName: 'ก้าวที่ 1: เริ่มจากศูนย์ — รู้จัก Studio และพื้นฐานภาษา Luau',
    estimatedHours: '5 - 8 ชั่วโมง',
    badgeTitle: '🐣 First Steps',
    shortSummary: 'สำหรับคนที่ไม่เคยแตะ Roblox Studio มาก่อน ปูพื้นฐานตั้งแต่หน้าจอ Studio, ตัวแปร, เงื่อนไข, ลูป, ตาราง, การจัดการวัตถุ (Instance) และการอ่าน error ให้พร้อมก่อนเข้าสู่การเขียนระบบเกมจริง',
    whyLearnFirst: 'ก้าวนี้คือ "รากฐาน" ที่ทุกก้าวต่อไปยืนอยู่บนนั้น หากข้ามไปเรียนเรื่องเครือข่ายหรือ DataStore ทันทีโดยไม่เข้าใจตัวแปร ลูป หรือการอ้างอิงวัตถุ จะทำให้ติดขัดตลอดเวลาและอ่านโค้ดตัวอย่างไม่ออก เมื่อผ่านก้าวนี้แล้ว คุณจะ "อ่านและแก้โค้ดพื้นฐานได้เอง" ซึ่งเป็นทักษะที่สำคัญที่สุดของนักพัฒนา',
    prerequisites: ['ติดตั้ง Roblox Studio และมีบัญชี Roblox', 'ใช้เมาส์และคีย์บอร์ดพื้นฐานได้'],
    keyTopicsToStudy: [
      {
        topicId: 'studio-interface-basics',
        title: 'รู้จักหน้าจอ Studio (Explorer, Properties, Output)',
        description: 'เข้าใจหน้าต่างหลักและความต่างของโหมด Play กับ Run ก่อนเขียนโค้ดบรรทัดแรก',
        docUrl: 'https://create.roblox.com/docs/studio/ui-overview'
      },
      {
        topicId: 'luau-variables-datatypes',
        title: 'ตัวแปรและชนิดข้อมูล (number, string, boolean)',
        description: 'เรียนรู้กล่องเก็บค่าและชนิดข้อมูลพื้นฐานที่ทุกระบบในเกมต้องใช้',
        docUrl: 'https://create.roblox.com/docs/tutorials/fundamentals/coding-1/coding-fundamentals'
      },
      {
        topicId: 'luau-conditionals',
        title: 'เงื่อนไข if / elseif / else',
        description: 'ทำให้เกมตัดสินใจได้ เช่น เลือดถึง 0 ไหม เงินพอซื้อไหม',
        docUrl: 'https://create.roblox.com/docs/tutorials/fundamentals/coding-3/landing'
      },
      {
        topicId: 'luau-loops',
        title: 'ลูป for และ while',
        description: 'ทำงานซ้ำอัตโนมัติ เช่น สร้างเหรียญ 100 อัน หรือทำไฟกะพริบ พร้อมกฎ task.wait()',
        docUrl: 'https://create.roblox.com/docs/tutorials/fundamentals/coding-4/landing'
      },
      {
        topicId: 'luau-tables-arrays-dictionaries',
        title: 'ตาราง Array & Dictionary',
        description: 'เก็บข้อมูลเป็นชุด เช่น รายการไอเทมในกระเป๋าและข้อมูลผู้เล่น',
        docUrl: 'https://create.roblox.com/docs/tutorials/fundamentals/coding-5/loops-and-arrays'
      },
      {
        topicId: 'instances-hierarchy-referencing',
        title: 'วัตถุ Instance และการอ้างอิง (Parent, WaitForChild)',
        description: 'สร้าง คัดลอก ลบ และอ้างอิงวัตถุในต้นไม้ของเกมอย่างถูกต้อง',
        docUrl: 'https://create.roblox.com/docs/studio/explorer'
      },
      {
        topicId: 'events-services-connections',
        title: 'Event, Service และ :Connect()',
        description: 'หัวใจของเกม event-driven รอเหตุการณ์เกิดแล้วตอบสนอง',
        docUrl: 'https://create.roblox.com/docs/tutorials/fundamentals/coding-2/functions-and-events'
      },
      {
        topicId: 'debugging-output-print',
        title: 'อ่าน error และดีบักด้วย print',
        description: 'ทักษะแก้ปัญหาด้วยตัวเอง อ่าน Output ออกและรู้ว่าผิดตรงไหน',
        docUrl: 'https://create.roblox.com/docs/studio/debugging'
      }
    ],
    handsOnPractices: [
      {
        title: 'สร้างสคริปต์แรก: print ข้อความลง Output',
        description: 'สร้าง Script ใน ServerScriptService พิมพ์ print("Hello") กด Play แล้วดูผลใน Output — ยืนยันว่าวางสคริปต์ถูกที่และรันได้',
        expectedCodeSnippet: 'print("Hello, Roblox!")'
      },
      {
        title: 'สร้าง Part ด้วยโค้ดแล้ววางในโลก',
        description: 'ฝึกใช้ Instance.new("Part"), ตั้ง property และที่สำคัญคือตั้ง .Parent = workspace ให้เห็นวัตถุจริง',
        expectedCodeSnippet: 'local p = Instance.new("Part"); p.Parent = workspace'
      },
      {
        title: 'บล็อกลาวาเหยียบแล้วตาย (Kill Brick)',
        challengeId: 'challenge-lava-brick',
        description: 'รวมทุกอย่าง: อ้างอิง Part, เชื่อม event .Touched, หา Humanoid ด้วย FindFirstChild แล้วสั่งให้ตาย',
        expectedCodeSnippet: 'part.Touched:Connect(function(hit) ... end)'
      }
    ],
    whatYouWillAchieve: [
      'เปิด Studio แล้วรู้ทันทีว่าหน้าต่างไหนทำอะไร และวางสคริปต์ที่ไหน',
      'เขียนตัวแปร เงื่อนไข ลูป และตาราง เพื่อควบคุมตรรกะพื้นฐานของเกมได้',
      'สร้าง อ้างอิง และลบวัตถุด้วยโค้ด โดยไม่ลืมตั้ง .Parent',
      'อ่าน error ใน Output ออก และดีบักปัญหาพื้นฐานได้ด้วยตัวเอง'
    ],
    proTipsForSuccess: [
      'อย่ารีบข้ามไปเรื่องยาก ฝึกพิมพ์โค้ดตามตัวอย่างเองทุกครั้ง อย่าแค่ก็อปวาง',
      'เปิด Output ค้างไว้ตลอดและใช้ print บ่อยๆ เพื่อดูว่าโค้ดวิ่งถึงไหนแล้ว',
      'ใช้ local นำหน้าตัวแปรทุกครั้ง และตั้งชื่อให้สื่อความหมาย'
    ],
    nextStageTeaser: 'เมื่อพื้นฐานแน่นแล้ว ก้าวต่อไปคือเจาะลึกชนิดของสคริปต์ 3 แบบ และโครงสร้าง Engine ให้ลึกขึ้นก่อนลุยระบบเครือข่าย!'
  },
  {
    id: 'stage-1-fundamentals',
    stepNumber: 2,
    stageName: 'Luau & Engine Fundamentals',
    thaiStageName: 'ก้าวที่ 2: พื้นฐานภาษา Luau และโครงสร้าง Roblox Engine',
  ...
  },
  {
    ...
    thaiStageName: 'ก้าวที่ 3: โครงข่าย Client-Server และกฎเหล็กความปลอดภัย',
    ...
    prerequisites: ['ผ่านก้าวที่ 2: เข้าใจความแตกต่างของ Script และ LocalScript'],
    keyTopicsToStudy: [
      {
  ...
  },
  {
    ...
    thaiStageName: 'ก้าวที่ 4: ระบบปฏิสัมพันธ์ในโลก 3 มิติ ฟิสิกส์ และ Raycasting',
    ...
    prerequisites: ['ผ่านก้าวที่ 2 และ 2: เขียนฟังก์ชันและเชื่อมโยง Event ได้คล่องแคล่ว'],
    keyTopicsToStudy: [
      {
  ...
  },
  {
    ...
    thaiStageName: 'ก้าวที่ 5: สถาปัตยกรรมโค้ดระดับสตูดิโอ และการขัดเกลาเกม (Polish)',
    estimatedHours: '5 - 7 ชั่วโมง',
    ...
    prerequisites: ['ผ่านก้าวที่ 2 - 3: เข้าใจการทำงานของ Instance และ Event'],
    keyTopicsToStudy: [
      {
  ...
  },
  {
    ...
    thaiStageName: 'ก้าวที่ 6: ฐานข้อมูลคลาวด์ และระบบเซฟป้องกันของปั๊ม (Session Locking)',
    ...
    prerequisites: ['ผ่านก้าวที่ 2 - 4: เขียนโค้ดแบบ Table Dictionary และ pcall ได้คล่อง'],
    keyTopicsToStudy: [
      {
  ...
  },
  {
    ...
    thaiStageName: 'ก้าวที่ 7: ระบบเกมลูปเต็มรูปแบบ การรองรับมือถือ และการสร้างรายได้จริง',
    ...
    prerequisites: ['ผ่านก้าวที่ 2 - 5: มีระบบโค้ด ระบบเซฟ และระบบความปลอดภัยครบถ้วน'],
    keyTopicsToStudy: [
      {
